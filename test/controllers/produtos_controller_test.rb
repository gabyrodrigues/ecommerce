...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { nome: @produto.nome, preco: @produto.preco, quantidade: @produto.quantidade } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { nome: @produto.nome, preco: @produto.preco, quantidade: @produto.quantidade } }
